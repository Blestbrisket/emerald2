...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_DEWPIDER] =
    {
        ...
        .abilities = { ABILITY_WATER_BUBBLE, ABILITY_WEAK_ARMOR, ABILITY_WATER_ABSORB },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_SALANDIT] =
    {
        ...
        .abilities = { ABILITY_CORROSION, ABILITY_RIVALRY, ABILITY_OBLIVIOUS },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_SANDYGAST] =
    {
        ...
        .abilities = { ABILITY_WATER_COMPACTION, ABILITY_SAND_COMPACTION, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_BROWN,
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal)          \
    ...
    [SPECIES_TURTONATOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_AFTERMATH, ABILITY_ANGER_SHELL },
        .bodyColor = BODY_COLOR_RED,
